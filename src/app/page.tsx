...
import { useBlockNumber, useGasPrice } from 'packages/blockchain/hooks';
...
const featureCards = [
  {
    icon: Globe,
    title: 'Sovereign',
    description: 'No L1 dependency, providing true autonomy and censorship resistance.',
  },
  {
    icon: Zap,
    title: 'Fast',
  ...
  },
  {
    icon: Lock,
    title: 'Secure',
    description: 'Fully EVM compatible, inheriting Ethereum\'s battle-tested security model.',
  },
];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {featureCards.map((feature) => (
              <Card key={feature.title} className="bg-card/50 backdrop-blur-sm border-white/10 hover:border-primary/50 transition-all hover:shadow-glow-blue">
                <CardHeader>
            ...
            <div className="mt-12 max-w-4xl mx-auto">
                <ul className="space-y-4">
                    {technologyItems.map((item, index) => (
                        <li key={index} className="bg-card p-4 rounded-lg flex items-center justify-between">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="w-full aspect-square bg-muted rounded-lg flex items-center justify-center">
                <p className="text-muted-foreground">Token Distribution Chart Placeholder</p>
              </div>
            </div>
          </div>
        </div>
